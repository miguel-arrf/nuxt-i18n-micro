---
url: 'https://s00d.github.io/nuxt-i18n-micro/api/packages.md'
description: >-
  The exported API of every workspace package, read at build time from the
  snapshots CI checks against the source.
---
...
| [`@i18n-micro/core`](/api/packages/core) | `@i18n-micro/core`, `@i18n-micro/core/devtools`, `@i18n-micro/core/helpers` | 53 |
...
| [`@i18n-micro/vitepress`](/api/packages/vitepress) | `@i18n-micro/vitepress`, `@i18n-micro/vitepress/config`, `@i18n-micro/vitepress/node`, `@i18n-micro/vitepress/theme` | 56 |
| [`@i18n-micro/vue`](/api/packages/vue) | `@i18n-micro/vue`, `@i18n-micro/vue/router` | 28 |
